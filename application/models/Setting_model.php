...
class Setting_model extends CI_Model {
    ...
    public function get($id = null) {
        ...
        $this->db->select('sch_settings.id,sch_settings.lang_id,sch_settings.doctor_restriction,sch_settings.mini_logo,sch_settings.is_rtl,sch_settings.cron_secret_key, sch_settings.timezone,
    ...
    public function getSetting() {
        ...
        $this->db->select('sch_settings.id,sch_settings.lang_id,sch_settings.is_rtl,sch_settings.fee_due_days,sch_settings.doctor_restriction,sch_settings.cron_secret_key,sch_settings.timezone,
          sch_settings.name,sch_settings.email,sch_settings.phone,languages.language,
