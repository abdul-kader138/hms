...
<div class="modal fade" id="addTestReportModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                        <form id="formbatch" enctype="multipart/form-data" accept-charset="utf-8"  method="post" class="ptt10" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <select class="form-control" name='customer_type' onchange="showtextbox(this.value)" id='customer_type' >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3" id="opd_ipd_no" style="display: none;">
                                    <div class="form-group">
            ...
            <div class="box-footer">
                <div class="pull-right">
                    <button type="submit" data-loading-text="<?php echo $this->lang->line('processing') ?>" id="formbatchbtn" class="btn btn-info pull-right" ><?php echo $this->lang->line('save'); ?></button>
                    </form>  
                </div>
            </div>
        </div>
