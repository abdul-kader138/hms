...
<!--            <li><a href="--><?php //echo site_url('admin/setup/bedtype') ?><!--" class="--><?php //echo set_sidebar_Submenu('admin/setup/bedtype'); ?><!--">--><?php //echo $this->lang->line('bed') . " " . $this->lang->line('type'); ?><!--</a></li>-->
            <li><a href="<?php echo site_url('admin/setup/bedgroup') ?>" class="<?php echo set_sidebar_Submenu('admin/setup/bedgroup'); ?>"><?php echo $this->lang->line('note_subcategory'); ?></a></li>
            <li>
                <a href="<?php echo site_url('admin/setup/floor') ?>" class="<?php echo set_sidebar_Submenu('admin/setup/floor'); ?>"><?php echo $this->lang->line('note_category'); ?></a></li>
        <?php } ?>                                                     
    </ul>
</div>
