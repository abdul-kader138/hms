...
<head>
    ...
    if ($this->customlib->getRTL() != "") {
        ...
        <!-- Bootstrap 3.3.5 RTL -->
        <link rel="stylesheet"
              href="<?php echo base_url(); ?>backend/rtl/bootstrap-rtl/css/bootstrap-rtl.min.css"/> <!-- Theme RTL style -->
...
<div class="wrapper">
    <header class="main-header" id="alert">
        <a href="<?php echo base_url(); ?>admin/admin/dashboard" class="logo">
            <span class="logo-mini"><img width="31" height="19" src="<?php echo $mini_logo; ?>"
                                         alt="<?php echo $this->customlib->getAppName() ?>"/></span>
            <span class="logo-lg"><img src="<?php echo $logo_image; ?>"
                                       alt="<?php echo $this->customlib->getAppName() ?>"/></span>
        </a>
                ...
                <div class="pull-right">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav headertopmenu">
                            <!--                                    <li class="">-->
                            <!--                                        -->
                            <?php //if ($this->rbac->hasPrivilege('bed_status', 'can_view')) { ?><!--<a  data-target="modal" href="#" id='beddata' data-loading-text="<i class='fa fa-spinner fa-spin '></i> -->
                            <?php //echo $this->lang->line('loading') ?><!--" onclick="getbedstatus()"><i class="fas fa-bed cal15"></i> <span class="spanDM">-->
                            <?php //echo $this->lang->line('bed') . " " . $this->lang->line('status'); ?><!--</span></a>-->
                            <!---->
                            <!--                                        </li>-->
                            <!--                                        --><?php
                            //                                    }?>
                            ...
                            if ($this->rbac->hasPrivilege('ipd reminder', 'can_add')) { ?>
                                <li class="dropdown hidden-sm">
                                    <a class="btn tip" title="<?= lang('reminder') ?>" data-placement="bottom" href="#" data-toggle="dropdown">
                                        <?php echo $this->lang->line('reminder') ?>
                                        <span style="background: yellow; color: black" class="badge yellow"><?= sizeof($this->customlib->getPatientNotifications()) ?></span>
                                    </a>
                                    <ul class="dropdown-menu pull-right content-scroll">
                                        <li class="dropdown-header">&nbsp;&nbsp;<i class="fa fa-info-circle"></i> <?= lang('reminder'); ?></li>
                                        <li class="dropdown-content">
                                            <div class="scroll-div">
                                                <div class="top-menu-scroll">
                                                    <ol>
                                                        <?php
                                                        $patient_notifications=$this->customlib->getPatientNotifications();
                                                        foreach ($patient_notifications as $n) {
                                                            echo '<li>' . $n->reminder_name .'( '.$n->patient_name.' )'. '</li>';
                                                        } ?>
                                                    </ol>
                                                </div>
                                            </div>
                                ...
                                if ($this->rbac->hasPrivilege('calendar_to_do_list', 'can_view')) {
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu menuboxshadow widthMo250">
                                            ...
                                            <li class="todoview plr10 ssnoti"><?php echo $this->lang->line('today_you_have'); ?> <?php echo $count; ?> <?php echo $this->lang->line('pending_task'); ?>
                                                <a href="<?php echo base_url() ?>admin/calendar/events"
                                                   class="pull-right pt0"><?php echo $this->lang->line('view'); ?><?php echo $this->lang->line('all'); ?></a>
                                            </li>
                                            <li>
                                                <ul class="todolist">
                                                    <?php
                                            ...
                                            <div class="sspass">
                                                <a href="<?php echo base_url() . "admin/staff/profile/" . $id ?>"
                                                   ...
                                                   data-original-title="<?php echo $this->lang->line('my_profile'); ?>"><i
                                                            class="fa fa-user"></i><?php echo $this->lang->line('profile'); ?>
                                                </a>
                                                <a class="pl25" href="<?php echo base_url(); ?>admin/admin/changepass"
                                                   data-toggle="tooltip" title=""
                                                   data-original-title="<?php echo $this->lang->line('change_password') ?>"><i
                                                            class="fa fa-key"></i><?php echo $this->lang->line('password'); ?>
