<aside class="main-sidebar" id="alert2">
    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
            ...
            //                                ?>
            <!--								<li class="treeview -->
            <?php //echo set_Topmenu('OPD_Out_Patient'); ?><!--">-->
            <!--                                    <a href="--><?php //echo base_url(); ?><!--admin/patient/search">-->
            <!--                                        <i class="fas fa-stethoscope"></i> <span> -->
            <?php //echo $this->lang->line('opd_out_patient');?><!--</span> -->
            <!--                                    </a>-->
            <!--                                    -->
            <!--                                </li>-->
            <!--                            --><?php //} }
                ...
                if ($this->rbac->hasPrivilege('ipd_patient', 'can_view')) {
                    ...
                    <li class="treeview <?php echo set_Topmenu('IPD_in_patient'); ?>">
                        <a href="<?php echo base_url() ?>admin/patient/ipdsearch">
                            ...
                            <span> <?php echo $this->lang->line('ipd_patient'); ?></span>
                        </a>
            ...
            <!--                                       <i class="fas fa-mortar-pestle"></i> <span> -->
            <?php //echo $this->lang->line('pharmacy');?><!--</span>-->
            <!--                                      -->
            <!--                                    </a>-->
            <!--                                </li>-->
            <!--                          --><?php //} }
            ...
            //                                ?><!--      -->
            <!--						        <li class="treeview -->
            <?php //echo set_Topmenu('pathology'); ?><!--">-->
            <!--                                    <a href="-->
            <?php //echo base_url(); ?><!--admin/pathology/search">-->
            <!--                                        <i class="fas fa-flask"></i> <span>-->
            <?php //echo $this->lang->line('pathology');?><!--</span>-->
            <!--                                       -->
            <!--                                    </a>-->
            <!--                                </li>-->
            <!--                              --><?php //} }
            ...
            //                                ?><!--  -->
            <!--								<li class="treeview -->
            <?php //echo set_Topmenu('operation_theatre');?><!-- ">-->
            <!--                                    <a href="-->
            <?php //echo base_url() ?><!--admin/operationtheatre/otsearch">-->
            <!--                                        <i class="fas fa-cut"></i> <span>-->
            <?php //echo $this->lang->line('operation_theatre');?><!--</span>-->
            <!--                                    </a>-->
            <!--                                    -->
            <!--                                </li>-->
            <!--                          --><?php //} }
            ...
            //                                ?><!--      -->
            <!--								<li class="treeview -->
            <?php //echo set_Topmenu('tpa_management');?><!--">-->
            <!--                                    <a href="--><?php //echo base_url()?><!--admin/tpamanagement">-->
            <!--                                        <i class="fas fa-umbrella"></i> <span>-->
            <?php //echo $this->lang->line('tpa_management');?><!--</span>-->
            <!--                                    </a>-->
            <!--                                    -->
            <!--                                </li>-->
            <!--                            --><?php //} }
            if (($this->module_lib->hasActive('income')) || ($this->module_lib->hasActive('expense'))) {
                if (($this->rbac->hasPrivilege('income', 'can_view')) || ($this->rbac->hasPrivilege('expense', 'can_view'))) {
                    ...
                    <a href="<?php echo base_url(); ?>admin/patient/search">
                        <i class="fas fa-money-bill-wave"></i> <span><?php echo $this->lang->line('finance'); ?></span>
                            ...
                            if ($this->rbac->hasPrivilege('income', 'can_view')) {
                                ...
                                <li class="<?php echo set_Submenu('income/index'); ?>"><a
                                            href="<?php echo base_url(); ?>admin/income"><i
                                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('income'); ?>
                                    </a></li>
                            <?php }
                        }
                        if ($this->module_lib->hasActive('expense')) {
                            if ($this->rbac->hasPrivilege('expense', 'can_view')) {
                                ...
                                <li class="<?php echo set_Submenu('expense/index'); ?>"><a
                                            href="<?php echo base_url(); ?>admin/expense"><i
                                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('expenses'); ?>
                                    </a></li>
                            <?php }
                        } ?>
                    </ul>
            ...
            <!--                                       <span> -->
            <?php //echo $this->lang->line('ambulance');?><!--</span> -->
            <!--                                      -->
            <!--                                    </a>-->
            <!--                                    -->
            <!--                                </li>-->
            ...
            if ($this->module_lib->hasActive('reports')) {
                ...
                <li class="treeview <?php echo set_Topmenu('Reports'); ?>">
                    ...
                    if ($this->rbac->hasPrivilege('transaction_report', 'can_view')) { ?>
                        <li class="<?php echo set_Submenu('admin/income/transactionreport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/income/transactionreport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('transaction_report'); ?>
                            </a>
                        </li>
                    <?php } ?>
                    <?php
                        ...
                        if ($this->rbac->hasPrivilege('appointment_report', 'can_view')) { ?>
                            <li class="<?php echo set_Submenu('admin/appointment/appointmentReport'); ?>"><a
                                        href="<?php echo base_url(); ?>admin/appointment/appointmentReport"><i
                                            class="fas fa-angle-right"></i> <?php echo $this->lang->line('appointment') . " " . $this->lang->line('report'); ?>
                                </a></li>
                        <?php }
                    } ?>
...
//
                    ?><!--<li class="--><?php //echo set_Submenu('admin/patient/opd_report');
                    ?><!--"><a href="--><?php //echo base_url();
                    ?><!--admin/patient/opd_report"><i class="fas fa-angle-right"></i> --><?php //echo $this->lang->line('opd')." ".$this->lang->line('report');
                    ?><!--</a></li>-->
                    <!--                                            --><?php
//                                        } }
//
                    if ($this->module_lib->hasActive('IPD')) {
                        if ($this->rbac->hasPrivilege('ipd_report', 'can_view')) {
                            ...
                            <li class="<?php echo set_Submenu('admin/patient/ipdreport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/patient/ipdreport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('ipd') . " " . $this->lang->line('report'); ?>
                            </a></li>
                            <?php
                        }
                    }
                        ...
                        if ($this->rbac->hasPrivilege('discharge_patient_report', 'can_view')) {
                            ...
                            <li class="<?php echo set_Submenu('admin/patient/dischargepatientReport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/patient/dischargepatientReport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('discharged') . " " . $this->lang->line('patient'); ?>
                            </a></li>
                            <?php
                        }
                    }
                    ...
                    if ($this->module_lib->hasActive('pharmacy')) {
                        if ($this->rbac->hasPrivilege('pharmacy_bill_report', 'can_view')) {
                            ...
                            <li class="<?php echo set_Submenu('admin/pharmacy/billreport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/pharmacy/billreport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('pharmacy') . " " . $this->lang->line('bill') . " " . $this->lang->line('report'); ?>
                            </a></li>
                            <?php
                        }
                    }
                        ...
                        if ($this->rbac->hasPrivilege('pathology_patient_report', 'can_view')) {
                            ...
                            <li class="<?php echo set_Submenu('admin/pathology/pathologyreport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/pathology/pathologyreport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('pathology') . " " . $this->lang->line('patient') . " " . $this->lang->line('report'); ?>
                            </a></li>
                            <?php
                        }
                    }
                        ...
                        if ($this->rbac->hasPrivilege('radiology_patient_report', 'can_view')) {
                            ...
                            <li class="<?php echo set_Submenu('admin/radio/radiologyreport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/radio/radiologyreport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('radiology') . " " . $this->lang->line('patient') . " " . $this->lang->line('report'); ?>
                            </a></li>
                            <?php
                        }
                    }
                        ...
                        if ($this->rbac->hasPrivilege('ot_report', 'can_view')) {
                            ...
                            <li class="<?php echo set_Submenu('admin/operationtheatre/otreport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/operationtheatre/otreport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('ot') . " " . $this->lang->line('report'); ?>
                            </a></li>
                            <?php
                        }
                    }
                        ...
                        if ($this->rbac->hasPrivilege('blood_issue_report', 'can_view')) {
                            ...
                            <li class="<?php echo set_Submenu('admin/bloodbank/bloodissuereport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/bloodbank/bloodissuereport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('blood') . " " . $this->lang->line('issue') . " " . $this->lang->line('report'); ?>
                            </a></li>
                            <?php
                        }
                    }
                        ...
                        if ($this->rbac->hasPrivilege('blood_donor_report', 'can_view')) {
                            ...
                            <li class="<?php echo set_Submenu('admin/bloodbank/blooddonorreport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/bloodbank/blooddonorreport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('blood') . " " . $this->lang->line('donor') . " " . $this->lang->line('report'); ?>
                            </a></li>
                            <?php
                        }
                    }
                        ...
                        if ($this->rbac->hasPrivilege('tpa_report', 'can_view')) {
                            ...
                            <li class="<?php echo set_Submenu('admin/tpamanagement/tpareport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/tpamanagement/tpareport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('organisation') . " " . $this->lang->line('report'); ?>
                            </a></li>
                            <?php
                        }
                    }
                        ...
                        if ($this->rbac->hasPrivilege('income_report', 'can_view')) { ?>
                            <li class="<?php echo set_Submenu('admin/income/incomesearch'); ?>"><a
                                        href="<?php echo base_url(); ?>admin/income/incomesearch"><i
                                            class="fas fa-angle-right"></i> <?php echo $this->lang->line('income') . " " . $this->lang->line('report'); ?>
                                </a></li>
                        <?php }
                    }
                    if ($this->module_lib->hasActive('expense')) {
                        if ($this->rbac->hasPrivilege('expense_report', 'can_view')) { ?>
                            <li class="<?php echo set_Submenu('admin/expense/expensesearch'); ?>"><a
                                        href="<?php echo base_url(); ?>admin/expense/expensesearch"><i
                                            class="fas fa-angle-right"></i> <?php echo $this->lang->line('expense') . " " . $this->lang->line('report'); ?>
                                </a></li>
                        <?php }
                    }
                    //   if ($this->module_lib->hasActive('income')) {
                        ...
                        if ($this->rbac->hasPrivilege('ambulance_report', 'can_view')) {
                            ...
                            <li class="<?php echo set_Submenu('admin/vehicle/ambulancereport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/vehicle/ambulancereport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('ambulance') . " " . $this->lang->line('report'); ?>
                            </a></li>
                            <?php
                        }
                    }
                    if ($this->rbac->hasPrivilege('payroll_month_report', 'can_view')) {
                        ...
                        <li class="<?php echo set_Submenu('admin/payroll/payrollreport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/payroll/payrollreport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('payroll') . " " . $this->lang->line('month') . " " . $this->lang->line('report'); ?>
                            </a></li>
                        <?php
                    }
                    if ($this->rbac->hasPrivilege('payroll_report', 'can_view')) {
                        ...
                        <li class="<?php echo set_Submenu('admin/payroll/payrollsearch'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/payroll/payrollsearch"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('payroll_report'); ?>
                            </a></li>
                        <?php
                    }
                    if ($this->rbac->hasPrivilege('staff_attendance_report', 'can_view')) {
                        ...
                        <li class="<?php echo set_Submenu('admin/staffattendance/attendancereport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/staffattendance/attendancereport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('staff_attendance_report'); ?>
                            </a></li>
                        <?php
                    }
                    ...
                    if ($this->rbac->hasPrivilege('user_log', 'can_view')) {
                        ...
                        <li class="<?php echo set_Submenu('userlog/index'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/userlog"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('user_log'); ?></a>
                        </li>
                    <?php }
                    if ($this->rbac->hasPrivilege('patient_login_credential', 'can_view')) {
                        ...
                        <li class="<?php echo set_Submenu('admin/patient/patientcredentialreport'); ?>"><a
                                    href="<?php echo base_url(); ?>admin/patient/patientcredentialreport"><i
                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('patient_login_credential'); ?>
                            </a></li>
                    <?php }
                    if ($this->module_lib->hasActive('communicate')) {
                        if ($this->rbac->hasPrivilege('email_sms_log', 'can_view')) {
                            ...
                            <li class="<?php echo set_Submenu('mailsms/index'); ?>"><a
                                        href="<?php echo base_url(); ?>admin/mailsms/index"><i
                                            class="fas fa-angle-right"></i> <?php echo $this->lang->line('email_/_sms_log'); ?>
                                </a></li>
                        <?php } ?>
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('general_setting', 'can_view')) {
                                ...
                                <li class="<?php echo set_Submenu('schsettings/index'); ?>"><a
                                            href="<?php echo base_url(); ?>schsettings"><i
                                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('settings'); ?>
                                    </a></li>
                                <?php
                            }
                            if ($this->rbac->hasPrivilege('hospital_charges', 'can_view')) {
                                ...
                                <li class="<?php echo set_Submenu('charges/index'); ?>"><a
                                            href="<?php echo base_url(); ?>admin/charges"><i
                                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('hospital') . " " . $this->lang->line('charges'); ?>
                                    </a></li>
                            <?php }
                            if ($this->module_lib->hasActive('IPD')) {
                                if ($this->rbac->hasPrivilege('bed_status', 'can_view')) {
                                    ...
                                    <?php if ($this->rbac->hasPrivilege('bed', 'can_view')) { ?>
                                        <li class="<?php echo set_Submenu('bed'); ?>"><a
                                                    href="<?php echo base_url(); ?>admin/setup/bedgroup"><i
                                                        class="fas fa-angle-right"></i> <?php echo $this->lang->line('patient_note'); ?>
                                            </a></li>
                                    <?php } ?>
                                <?php }
                            }
                            if ($this->module_lib->hasActive('OPD')) {
                                if (($this->rbac->hasPrivilege('opd_prescription_print_header_footer', 'can_view')) || ($this->rbac->hasPrivilege('ipd_prescription_print_header_footer', 'can_view')) || ($this->rbac->hasPrivilege('pharmacy_bill_print_header_footer', 'can_view'))) {
                                    ...
                                    <li class="<?php echo set_Submenu('admin/printing'); ?>"><a
                                                href="<?php echo base_url(); ?>admin/printing"><i
                                                    class="fas fa-angle-right"></i> <?php echo $this->lang->line('print') . " " . $this->lang->line('header') . " " . $this->lang->line('footer'); ?>
                                        </a></li>
                                <?php }
                            }
                            if ($this->module_lib->hasActive('front_office')) {
                                if ($this->rbac->hasPrivilege('setup_front_office', 'can_view')) {
                                    ...
                                    <li class="<?php echo set_Submenu('admin/visitorspurpose'); ?>"><a
                                                href="<?php echo base_url(); ?>admin/visitorspurpose"><i
                                                    class="fas fa-angle-right"></i> <?php echo $this->lang->line('front_office'); ?>
                                        </a></li>
                            ...
                            if ($this->module_lib->hasActive('pharmacy')) {
                                if ($this->rbac->hasPrivilege('medicine_category', 'can_view')) {
                                    ...
                                    <li class="<?php echo set_Submenu('medicine/index'); ?>"><a
                                                href="<?php echo base_url(); ?>admin/medicinecategory/medicine"><i
                                                    class="fas fa-angle-right"></i> <?php echo $this->lang->line('pharmacy'); ?>
                                        </a></li>
                                <?php }
                            }
                            if ($this->module_lib->hasActive('pathology')) {
                                if ($this->rbac->hasPrivilege('pathology_category', 'can_view')) {
                                    ...
                                    <li class="<?php echo set_Submenu('addCategory/index'); ?>"><a
                                                href="<?php echo base_url(); ?>admin/pathologycategory/addcategory"><i
                                                    class="fas fa-angle-right"></i> <?php echo $this->lang->line('pathology'); ?>
                                        </a></li>
                                <?php }
                            }
                            if ($this->module_lib->hasActive('radiology')) {
                                if ($this->rbac->hasPrivilege('radiology_category', 'can_view')) {
                                    ...
                                    <li class="<?php echo set_Submenu('addlab/index'); ?>"><a
                                                href="<?php echo base_url(); ?>admin/lab/addLab"><i
                                                    class="fas fa-angle-right"></i> <?php echo $this->lang->line('radiology'); ?>
                                        </a></li>
                                <?php }
                            }
                            if (($this->module_lib->hasActive('income')) || ($this->module_lib->hasActive('expense'))) {
                                ...
                                if (($this->rbac->hasPrivilege('income_head', 'can_view')) || ($this->rbac->hasPrivilege('income_head', 'can_view'))) {
                                    ...
                                    <li class="<?php echo set_Submenu('finance/index'); ?>"><a
                                                href="<?php echo base_url(); ?>admin/incomehead"><i
                                                    class="fas fa-angle-right"></i> <?php echo $this->lang->line('finance'); ?>
                                        </a></li>
                                <?php }
                            }
                            if (($this->rbac->hasPrivilege('leave_types', 'can_view')) || ($this->rbac->hasPrivilege('leave_types', 'can_view'))) {
                                ...
                                <li class="<?php echo set_Submenu('hr/index'); ?>"><a
                                            href="<?php echo base_url(); ?>admin/leavetypes"><i
                                                class="fas fa-angle-right"></i> <?php echo $this->lang->line('human_resource'); ?>
                                    </a></li>
                                <?php
                            }
                            if ($this->module_lib->hasActive('inventory')) {
                                if ($this->rbac->hasPrivilege('item_category', 'can_view')) {
                                    ...
                                    <li class="<?php echo set_Submenu('inventory/index'); ?>"><a
                                                href="<?php echo base_url(); ?>admin/itemcategory"><i
                                                    class="fas fa-angle-right"></i> <?php echo $this->lang->line('inventory'); ?>
                                        </a></li>
                                <?php }
                            } ?>
